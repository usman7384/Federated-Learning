...
def parse_args(args_list=None):
    ...
    parser.add_argument(
        ...
        help="if selected, client are sampled with replacement; default is False",
        action='store_true'
    )
    parser.add_argument(
        '--local_optimizer',
    ...
    parser.add_argument(
        "--mu",
        help='proximal / penalty term weight, used when --local_optimizer=`prox_sgd`; '
             'default is `0.`',
        type=float,
        default=0
    )
    ...
    parser.add_argument(
        "--bz",
        type=int,
        help='batch size used for train and test, default is 128',
        default=128
    )
    parser.add_argument(
        '--device',
    ...
    parser.add_argument(
        "--prop",
        help='proportion of malicious clients in the system; default is 0.0',
        type=float,
        default=0.0
    )
